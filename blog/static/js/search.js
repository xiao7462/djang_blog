...
! function (e) {
    SearchService = function (t) {
        ...
        o.config = e.extend({
            ...
            imagePath: ROOT + "img/"
        }, t), o.dom = {}, o.percentLoaded = 0, o.open = !1, o.queryText = "", o.nav = {
            next: -1,
            prev: -1,
            total: 0,
            current: 1
        }, o.parseSelectors = function () {
...
function (e) {
    ...
    AlgoliaSearch = function (a) {
        ...
        var t = this,
            o = "https://" + t.config.app_id + "-dsn.algolia.net/1/indexes/" + t.config.indexName;
        return t.addLogo("algolia"), t.buildResultList = function (a) {
            ...
            return e.each(a, function (e, a) {
                ...
                var r = a.title,
                    i = a._highlightResult.excerptStrip.value || "";
            ...
            e.get(o, {
                query: a,
                page: n - 1,
                hitsPerPage: t.config.per_page,
                "x-algolia-application-id": t.config.app_id,
                "x-algolia-api-key": t.config.apiKey
            }, function (e, o) {
...
function (e) {
    ...
    AzureSearch = function (a) {
        SearchService.apply(this, arguments);
        var t = this,
            o = "https://" + t.config.serviceName + ".search.windows.net/indexes/" + t.config.indexName + "/docs?api-version=2015-02-28";
        return t.nav.current = 1, t.addLogo("azure"), t.buildResultList = function (a) {
            ...
            e.ajax({
                ...
                headers: {
                    ...
                    "api-key": t.config.queryKey
                },
                data: {
                    search: a,
                    $orderby: "date desc",
                    $skip: n - 1,
                    $top: t.config.per_page,
                    $count: !0
                },
                type: "GET",
...
function (e) {
    ...
    BaiduSearch = function (a) {
        ...
        }, t.buildMetadata = function (e) {}, t.loadScript = function () {
...
! function (e) {
    ...
    GoogleCustomSearch = function (a) {
        ...
        return t.addLogo("google"), t.buildResultList = function (a) {
            ...
            e.get("https://www.googleapis.com/customsearch/v1", {
                key: t.config.apiKey,
                cx: t.config.engineId,
                q: a,
                start: o,
                num: t.config.per_page
            }, function (e, o) {
...
function (e) {
    ...
    HexoSearch = function (a) {
        ...
        return t.config.endpoint = ROOT + ((a || {}).endpoint || "content.json"), t.config.endpoint = t.config.endpoint.replace("//", "/"), t.cache = "", t.contentSearch = function (a, t) {
            var o = a.title.trim().toLowerCase(),
                n = a.text.trim().toLowerCase(),
                r = t.trim().toLowerCase().split(" "),
                i = !1,
                s = -1,
                c = -1,
                l = -1;
                ...
                if (s = o.indexOf(t), c = n.indexOf(t), s < 0 && c < 0 ? i = !1 : (i = !0, c < 0 && (c = 0), 0 === e && (l = c)), i) {
                    ...
                    if (l >= 0) {
                        ...
                        r.forEach(function (e) {
                            ...
                            m = m.replace(a, "<b style='color: red'>" + e + "</b>")
                        }), a.digest = m
            ...
            if (t.cache) {
                ...
                if ("success" !== o || !e || !e.posts && !e.pages || e.posts.length < 1 && e.pages.length < 1) t.onQueryError(a, o);
                else {
                    t.cache = e;
                    var r = "";
